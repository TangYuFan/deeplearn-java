 ...
 *  @auth: TYF
 */
public class e2_pose_detection_video {
...
//                    Imgproc.circle(dst, pp17, 2, color17, 2);
                ...
                // 转为原始尺寸
                this.src = this.resizeWithoutPadding(this.dst,src.width()*2,src.height()*2);
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 视频、rtsp流等
        String video = new File("").getCanonicalPath() + "\\model\\deeplearning\\e2_pose_detection\\people.mp4";
        ...
        while (cap.read(frame)) {
            ...
            try {
                ...
                // 显示处理后的图像
                org.opencv.highgui.HighGui.imshow("Video", res.src);
