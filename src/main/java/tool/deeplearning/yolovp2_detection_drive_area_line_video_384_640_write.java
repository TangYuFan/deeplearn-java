...
/**
 *   @desc : YOLOPV2目标检测+可驾驶区域分割+车道线分割  然后生成新的视频
 ...
 */
public class yolovp2_detection_drive_area_line_video_384_640_write {
...
//                e.printStackTrace();
    ...
    public static void main(String[] args) throws Exception{
        ...
        VideoWriter videoWriter = new VideoWriter(filename, VideoWriter.fourcc('M', 'J', 'P', 'G'), fps, new Size(640*2, 384));
