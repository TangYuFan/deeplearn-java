 ...
 */
public class hand_3d_landmark_video {
...
//                    System.out.println("hand置信度:"+score+",左右:"+lr+",21关键点xyz:"+Arrays.toString(xyz));
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 视频、rtsp流等
        String video = new File("").getCanonicalPath() +
                "\\model\\deeplearning\\hand_3d_landmark\\IMG_3496.mp4";
        ...
        while (cap.read(frame)) {
            ...
            try {
                ...
                if(tuse>(1000/30)){
                    ...
                    org.opencv.highgui.HighGui.waitKey(1000/30-Long.valueOf(tuse).intValue());
                }
