...
/**
*   @desc : 安全帽检测 , darknet53 模型 ,djl 推理
*   @auth : tyf
*   @date : 2022-06-15  09:11:41
*/
public class safety_helmet_detect_darknet53_djl {


    public static class LargeSafetyHelmetDetect {
    ...
    public static void main(String[] args) throws IOException, ModelException, TranslateException {
        ...
        String modelPath = new File("").getCanonicalPath()+
                "\\model\\deeplearning\\safety_helmet_detect_darknet53_djl\\darknet53.zip";

        // 测试图片
        String picPath = new File("").getCanonicalPath()+
                "\\model\\deeplearning\\safety_helmet_detect_darknet53_djl\\safety_helmet.jpg";


        Path imageFile = new File(picPath).toPath();
        Image image = ImageFactory.getInstance().fromFile(imageFile);
        Criteria<Image, DetectedObjects> criteria = new LargeSafetyHelmetDetect().criteria(image,modelPath);
