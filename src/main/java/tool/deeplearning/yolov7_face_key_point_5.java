...
/**
*   @desc : 使用ONNXRuntime部署YOLOV7人脸+关键点检测
*   @auth : tyf
*   @date : 2022-04-28  16:28:22
*/
public class yolov7_face_key_point_5 {
    ...
    public static class ImageObj{
        ...
        public void show(){
            ...
            datas.stream().forEach(n->{
                ...
                float x2 = n[2];
                float y2 = n[3];
                float score1 = n[4];// 类别信度
                float score2 = n[5];// 边框置信度

                float point1_x = n[6];// 关键点1
                float point1_y = n[7];// 关键点1
                float point1_score = n[8];// 关键点1

                float point2_x = n[9];// 关键点2
                float point2_y = n[10];// 关键点2
                float point2_score = n[11];// 关键点2

                float point3_x = n[12];// 关键点3
                float point3_y = n[13];// 关键点3
                float point3_score = n[14];// 关键点3

                float point4_x = n[15];// 关键点4
                float point4_y = n[16];// 关键点4
                float point4_score = n[17];// 关键点4

                float point5_x = n[18];// 关键点5
                float point5_y = n[19];// 关键点5
                float point5_score = n[20];// 关键点5
    ...
    public static void main(String[] args) throws Exception{
        ...
        ---------模型输出-----------
        out -> [1, 25500, 21] -> FLOAT
         */
        init1(new File("").getCanonicalPath()+"\\model\\deeplearning\\yolov7_face_key_point_5\\yolov7-w6-face.onnx");
