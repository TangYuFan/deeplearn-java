...
*/
public class google_move_net_people_key_point_video {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 视频、rtsp流等
        String video = new File("").getCanonicalPath() + "\\model\\deeplearning\\google_move_net_people_key_point\\move.mp4";
